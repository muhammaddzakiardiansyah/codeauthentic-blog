...
<div class="container">
    <div class="row justify-content-center">
            ...
            <div class="col-md-6 align-self-center mt-2">
              <div class="card" style="width: 33rem;">
                ...
                <div class="content">
                    ...
                    <a href="/posts" class="badge text-bg-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-90deg-left" viewBox="0 0 16 16">
            ...
            <div class="form-floating mt-4">
                <textarea class="form-control mt-2" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 400px" autofocus></textarea>
